@extends('layouts.app', ['activePage' => 'user-management', 'titlePage' => __('EditarUsuario')])
@section('content')
<div class="content">
        ...
        <form action="{{ route('user.update', $user->id) }}" method="post" class="form-horizontal">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <label for="confirm-password" class="col-sm-2 col-form-label">Contraseña</label>
                <div class="col-sm-7">
                  <input type="password" class="form-control" name="confirm-password" placeholder="Confirmar  Nueva Contraseña">
                  @if ($errors->has('password'))
                    <span class="error text-danger" for="input-password">{{ $errors->first('confirm-password') }}</span>
                  @endif
                </div>
              </div>
              <div class="row">
