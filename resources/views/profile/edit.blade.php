        ...
        <div class="col-md-12">
          <form method="post" action="{{ route('profile.password') }}" class="form-horizontal">
            ...
            <div class="card ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                      ...
                      name="password" id="input-password" type="password" placeholder="{{ __('Nueva Contraseña') }}" 
                      value="" required />
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-primary">{{ __('Guardar la Nueva Contraseña') }}</button>
              </div>
            </div>
          </form>
        </div>
